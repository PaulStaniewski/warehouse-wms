...
from operations.scanner_views import (
    ...
    ScannerCartWorkClaimView,
    ScannerCartWorkJoinView,
    ScannerCartWorkLeaveView,
    ...
    ScannerContentsView,
    ScannerCycleCountSaveLineView,
    ScannerCycleCountRecountDetailView,
    ScannerCycleCountRecountSubmitView,
    ScannerCycleCountRecountsView,
    ScannerCycleCountSessionDetailView,
    ScannerCycleCountSessionsView,
    ScannerCycleCountSubmitLocationView,
    ScannerLocationContentsView,
    ScannerPickingPickView,
    ScannerPickingReportShortageView,
    ScannerPickingConfirmLocationView,
    ScannerPickingPrepareView,
    ScannerPickingScanView,
    ScannerPickingShortageChallengeView,
...
urlpatterns = [
    ...
    path("api/scanner/cart-work/join/", ScannerCartWorkJoinView.as_view(), name="scanner-cart-work-join"),
    path("api/scanner/cart-work/claim/", ScannerCartWorkClaimView.as_view(), name="scanner-cart-work-claim"),
    path("api/scanner/cart-work/leave/", ScannerCartWorkLeaveView.as_view(), name="scanner-cart-work-leave"),
    ...
    path("api/scanner/picking/shortage-challenge/", ScannerPickingShortageChallengeView.as_view(), name="scanner-picking-shortage-challenge"),
    path("api/scanner/picking/report-shortage/", ScannerPickingReportShortageView.as_view(), name="scanner-picking-report-shortage"),
    ...
    path("api/scanner/cycle-counts/", ScannerCycleCountSessionsView.as_view(), name="scanner-cycle-count-sessions"),
    path("api/scanner/cycle-counts/<int:session_id>/", ScannerCycleCountSessionDetailView.as_view(), name="scanner-cycle-count-session-detail"),
    path("api/scanner/cycle-counts/<int:session_id>/locations/<int:location_id>/count/", ScannerCycleCountSaveLineView.as_view(), name="scanner-cycle-count-save-line"),
    path("api/scanner/cycle-counts/<int:session_id>/locations/<int:location_id>/submit/", ScannerCycleCountSubmitLocationView.as_view(), name="scanner-cycle-count-submit-location"),
    path("api/scanner/cycle-count-recounts/", ScannerCycleCountRecountsView.as_view(), name="scanner-cycle-count-recounts"),
    path("api/scanner/cycle-count-recounts/<int:recount_id>/", ScannerCycleCountRecountDetailView.as_view(), name="scanner-cycle-count-recount-detail"),
    path("api/scanner/cycle-count-recounts/<int:recount_id>/submit/", ScannerCycleCountRecountSubmitView.as_view(), name="scanner-cycle-count-recount-submit"),
